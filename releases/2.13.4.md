...
* When compiling on JDK 15, avoid clash with new `CharSequence#isEmpty` method https://github.com/scala/scala/pull/9292
...
* Make `MapView#values` preserve laziness https://github.com/scala/scala/pull/9090
* Make `ListBuffer`'s iterator fail when the buffer is mutated https://github.com/scala/scala/pull/9174
* Un-deprecate useful `StringOps` methods, despite Unicode concerns https://github.com/scala/scala/pull/9246
